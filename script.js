...
// Enhanced dropdown functionality - CORRECTED VERSION
...
function closeAllDropdowns() {
    document.querySelectorAll('.dropdown').forEach(dropdown => {
        ...
        const chevron = dropdown.querySelector('.nav-link i');
        if (chevron) {
...
// Clean setup for dropdowns
function setupDropdowns() {
    // Re-select dropdowns to ensure we have current elements
    ...
    currentDropdowns.forEach(dropdown => {
        ...
        newDropdownLink.addEventListener('click', (e) => {
            ...
            if (!isCurrentlyActive) {
                ...
                const newChevron = dropdown.querySelector('.nav-link i');
                if (newChevron) {
...
// Re-initialize when DOM changes (if needed)
const observer = new MutationObserver(() => {
    setupDropdowns();
    setupDropdownItems();
});

observer.observe(document.querySelector('.nav-menu'), {
    childList: true,
    subtree: true
});
